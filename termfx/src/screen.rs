...
/// The main struct for the screen.
/// 
/// This, at it's core, has a 2D vector that contains every pixel on the screen.
pub struct Screen {
    pub height: usize,
    pub width: usize,
...
impl Screen {
    ...
    /// Renders some text.
    pub fn text(&mut self, x: usize, y: usize, color: RGB, font: &Font, text: &str) {
        let mut line = 0;
        let mut offset = 0;
